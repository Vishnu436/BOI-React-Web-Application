...
const Application = () => {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = API.fetchAPI(
        "/customer/api/v1/loadApplication",obj
      );
      ...
      if (response.ok) {
        ...
        setinitialValues({
          ...
          Cus_Marital_Status: responseBody.CustomerPersonalDetails.Cus_Marital_Status,
          Cus_PostalCode : responseBody.CustomerPersonalDetails.Cus_PostalCode,
          Cus_Address_LandMark : responseBody.CustomerPersonalDetails.Cus_Address_LandMark,
          ...
          Cus_Preferred_Language : responseBody.CustomerPersonalDetails.Cus_Preferred_Language,
          DOB : responseBody.CustomerPersonalDetails.DOB,
          Emergency_Contact : responseBody.CustomerPersonalDetails.Emergency_Contact,
          ...
          Cus_SourceOfIncome: responseBody.CustomerEmploymentDetails.Cus_SourceOfIncome,
          Cust_Account_Type : responseBody.CustomerAccountdetails.Cust_Account_Type,
          Cust_Initial_Deposit_Amount : responseBody.CustomerAccountdetails.Cust_Initial_Deposit_Amount,
          Cust_Nominee_Details: responseBody.CustomerAccountdetails.Cust_Nominee_Details,
          Cust_Nominee_Relation: responseBody.CustomerAccountdetails.Cust_Nominee_Relation,
          Cus_Annual_Income : responseBody.CustomerEmploymentDetails.Cus_Annual_Income,
          Cus_Employer_Name : responseBody.CustomerEmploymentDetails.Cus_Employer_Name,
          Cus_Employment_Status : responseBody.CustomerEmploymentDetails.Cus_Employment_Status ,
          Cus_Tax_Identification_Number : responseBody.CustomerEmploymentDetails.Cus_Tax_Identification_Number,
          Cus_Id_ExpiryDate : responseBody.CustomerIdentityDetails.Cus_Id_ExpiryDate,
        ...
        console.log(responseBody.CustomerKYCDetails.Cus_Signature)
      } else {
  ...
  useEffect(() => {
    ...
    const fetchDataValidation = async(values) => {
      ...
      try {
        const obj = {
          ...
          const response = await API.fetchAPI('/customer/api/v1/updateApplicationStatus', obj);
  ...
  async function SubmitForm(key) {
    ...
    try {
      const obj = {
        ...
        Approved_By : 'lallikrishna@gmail.com',
        remarks : state.record.remarks
      }
        const response = await fetch('/customer/api/v1/updateApplicationStatus', obj );
  ...
  return (
    <>
      ...
      <Col span={8}>
        <Form.Item label="Address Proof" valuePropName="fileList" required='true'>
      ...
      <Col span={8}>
        <Form.Item label="Id Proof" valuePropName="fileList" required='true'>
      ...
      <Col span={8}>
        <Form.Item label="Photo Proof" valuePropName="fileList" required='true'>
      ...
      <Col span={8}>
        <Form.Item label="Signature" valuePropName="fileList" required='true'>
          ...
          <Col span={24}>
            ...
            >
              <Input.TextArea placeholder={"Remarks"} disabled={false} autoSize= {{ minRows: 6, maxRows: 6 } }/>
            </Form.Item>
          </Col>
            ...
            >
              <Space size={30}>
                ...
                <Modal
                    ...
                    centered
                    open={reject}
                    onOk={() => {navigate('/main/dashboard')}}
                    onCancel={() => setreject(false)}
                  >
                    <p> Form is rejected, Please check the details and submit again </p>
                  </Modal>
                
                <Button type="primary"  htmlType="button" style={{backgroundColor:'#7149C6'}} disabled={!submittable} onClick={() => [SubmitForm('Approve'), setapprove(true)]}
                >
                  Approve
                </Button>
                <Modal
